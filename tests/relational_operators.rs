...
mod relational_tests {
    ...
    fn compares_two_integers_with_greater_than_false() {
        utils::assert_input("print 1>2;", predicates::str::contains("0"));
    }

    #[test]
    fn compares_two_integers_with_greater_than_true() {
        utils::assert_input("print 2>1;", predicates::str::contains("1"));
    }

    #[test]
    fn compares_two_integers_with_less_than_false() {
        utils::assert_input("print 2<1;", predicates::str::contains("0"));
    }
    ...
    fn compares_two_integers_with_greater_equal_than_same_val_true() {
        utils::assert_input("print 2>=2;", predicates::str::contains("1"));
    }
    ...
    fn compares_two_integers_with_not_equal_false() {
        utils::assert_input("print 2!=2;", predicates::str::contains("0"));
    }

    #[test]
    fn compares_two_strings_double_equal_same_case() {
        utils::assert_input("print \"a\"==\"a\";", predicates::str::contains("1"));
    }

    #[test]
    fn compares_two_strings_double_equal_same_case_multiple_char() {
        utils::assert_input("print \"abc\"==\"abc\";", predicates::str::contains("1"));
    }

    #[test]
    fn compares_two_strings_double_equal_diff_case() {
        utils::assert_input("print \"a\"==\"A\";", predicates::str::contains("0"));
    }

    #[test]
    fn compares_two_strings_double_equal_diff_case_multiple_char() {
        utils::assert_input("print \"abc\"==\"aBc\";", predicates::str::contains("0"));
    }

    #[test]
    fn compares_two_strings_double_equal_empty_lhs() {
        utils::assert_input("print \"\"==\"a\";", predicates::str::contains("0"));
    }
    ...
    fn compares_two_strings_not_equal_empty_lhs() {
        utils::assert_input("print \"\"!=\"a\";", predicates::str::contains("1"));
    }
    ...
    fn compares_two_strings_greater_equal_diff_case_multiple_char_diff_len() {
        utils::assert_input("print \"a\">=\"aBc\";", predicates::str::contains("0"));
    }

    #[test]
    fn compares_two_strings_greater_equal_diff_case_multiple_char_diff_len_two() {
        utils::assert_input("print \"aBc\">=\"a\";", predicates::str::contains("1"));
    }
    ...
    fn compares_two_strings_less_than_equal_diff_case_multiple_char_diff_len() {
        utils::assert_input("print \"a\"<=\"aBc\";", predicates::str::contains("1"));
    }

    #[test]
    fn compares_two_strings_less_than_equal_diff_case_multiple_char_diff_len_two() {
        utils::assert_input("print \"aBc\"<=\"a\";", predicates::str::contains("0"));
    }
    ...
    fn compares_a_number_and_string_double_equal() {
        utils::assert_input("print \"a\"==1;", predicates::str::contains("0"));
    }

    #[test]
    fn compares_a_number_and_string_not_equal() {
        utils::assert_input("print \"a\"!=1;", predicates::str::contains("1"));
    }
    ...
    fn compares_a_number_and_string_greater_equal_symmetric() {
        utils::assert_input("print 1>=\"a\";", predicates::str::contains("0"));
    }
    ...
    fn compares_a_number_and_string_less_than_equal_symmetric() {
        utils::assert_input("print 1<=\"a\";", predicates::str::contains("1"));
    }
