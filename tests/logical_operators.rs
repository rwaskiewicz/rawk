...
mod logical_tests {
    ...
    fn it_performs_logical_not_on_zero() {
        utils::assert_input("!0", predicates::str::contains("1.0"));
    }

    #[test]
    fn it_performs_logical_not_on_non_zero_integer() {
        utils::assert_input("!9", predicates::str::contains("0.0"));
    }
    ...
    fn it_performs_double_logical_not_on_non_zero_integer() {
        utils::assert_input("!!9", predicates::str::contains("1.0"));
    }
    ...
    fn it_performs_unary_negation_on_empty_string() {
        utils::assert_input("!\"\"", predicates::str::contains("1.0"));
    }

    #[test]
    fn it_performs_unary_negation_on_non_empty_string() {
        utils::assert_input("!\"Hello World\"", predicates::str::contains("0.0"));
    }
    ...
    fn it_performs_unary_negation_on_string_1() {
        utils::assert_input("!\"1\"", predicates::str::contains("0.0"));
    }
}
