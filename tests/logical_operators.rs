...
mod logical_tests {
    ...
    fn it_performs_logical_not_on_zero() {
        utils::run_rawk(Some("{print !0;}"), vec!["-q"], None, Some("1"));
    }

    #[test]
    fn it_performs_logical_not_on_non_zero_integer() {
        utils::run_rawk(Some("{print !9;}"), vec!["-q"], None, Some("0"));
    }
    ...
    fn it_performs_double_logical_not_on_non_zero_integer() {
        utils::run_rawk(Some("{print !!9;}"), vec!["-q"], None, Some("1"));
    }
    ...
    fn it_performs_unary_negation_on_empty_string() {
        ...
        utils::run_rawk(Some("{print !\"\";}"), vec!["-q"], None, Some("1"));
    }
    ...
    fn it_performs_unary_negation_on_string_1() {
        utils::run_rawk(Some("{print !\"1\";}"), vec!["-q"], None, Some("0"));
    }

    #[test]
    fn it_performs_logical_and_truthy_returns_true() {
        utils::run_rawk(Some("{print 1 && 1;}"), vec!["-q"], None, Some("1"));
    }

    #[test]
    fn it_performs_logical_and_falsy_lhs_returns_false() {
        utils::run_rawk(Some("{print 0 && 1;}"), vec!["-q"], None, Some("0"));
    }
    ...
    fn it_performs_logical_and_with_0_str_returns_true() {
        utils::run_rawk(Some("{print 1 && \"0\";}"), vec!["-q"], None, Some("1"));
    }
    ...
    fn it_performs_logical_or_falsy_lhs_returns_true() {
        utils::run_rawk(Some("{print 0 || 1;}"), vec!["-q"], None, Some("1"));
    }
    ...
    fn it_performs_logical_or_with_empty_str_returns_true() {
        utils::run_rawk(Some("{print 1 || \"\";}"), vec!["-q"], None, Some("1"));
    }

    #[test]
    fn it_performs_logical_or_with_expr_returns_false() {
        utils::run_rawk(Some("{print 0 || 1 - 1;}"), vec!["-q"], None, Some("0"));
    }

    #[test]
    fn it_short_circuits_logical_or_on_the_first_truthy_value() {
        utils::run_rawk(
            Some("{1 || foo = 2; print foo;}"),
            vec!["-q"],
            None,
            Some(""),
        );
